...
def main():
  samples = np.load('data/v1/samples.npy')
  queries = np.load('data/v1/queries.npy')
  ...
  np.save('data/v1/rebalanced_samples.npy', samples[np.concatenate((true_exists, false_subset))])
  np.save('data/v1/rebalanced_queries.npy', queries[np.concatenate((true_exists, false_subset))])
  np.save('data/v1/rebalanced_labels.npy', labels[np.concatenate((true_exists, false_subset))])
