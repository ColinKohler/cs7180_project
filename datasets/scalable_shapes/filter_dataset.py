...
def main():
  ...
  np.save('data/v2/rebalanced_samples.npy', samples[np.concatenate((true_relation, exists_subset, false_subset))])
  np.save('data/v2/rebalanced_queries.npy', queries[np.concatenate((true_relation, exists_subset, false_subset))])
  np.save('data/v2/rebalanced_labels.npy', labels[np.concatenate((true_relation , exists_subset, false_subset))])
