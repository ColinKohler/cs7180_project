...
def main():
  ...
  np.save('rebalenced_samples.npy', samples[np.concatenate((true_relation, exists_subset, false_subset))])
  np.save('rebalenced_queries.npy', queries[np.concatenate((true_relation, exists_subset, false_subset))])
  np.save('rebalenced_labels.npy', labels[np.concatenate((true_relation, exists_subset, false_subset))])
